...
```{r}
home <- gameData %>%
  select("season", "week", "date", starts_with("home"), starts_with("H"), starts_with("away"), starts_with("A"), homeWin, -c(AFinal, HFinal, awayTeam, awayAbb, awayElo, awayTOP, awayPenYds, awayNumPen, ATotalPlays, homeAbb)) %>%
...
away <- gameData %>%
  select("season", "week", "date", starts_with("home"), starts_with("H"), starts_with("away"), starts_with("A"), homeWin, -c(AFinal, HFinal, homeTeam, homeAbb, homeElo, homeTOP, homePenYds, homeNumPen, HTotalPlays, awayAbb)) %>%
